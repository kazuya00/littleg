...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/littleengine2

dist/Release/GNU-Linux-x86/littleengine2: ${OBJECTFILES}
...
${OBJECTDIR}/EventDispatcher.o: nbproject/Makefile-${CND_CONF}.mk EventDispatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EventDispatcher.o EventDispatcher.cpp
...
${OBJECTDIR}/ActorContactListener.o: nbproject/Makefile-${CND_CONF}.mk ActorContactListener.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ActorContactListener.o ActorContactListener.cpp

${OBJECTDIR}/AnimatedTexture.o: nbproject/Makefile-${CND_CONF}.mk AnimatedTexture.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/AnimatedTexture.o AnimatedTexture.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/littleengine2
